// Layton et al. - Level 3 simplificado (r=4).
...
Transfinite Curve {10,12,14,16} = 10*r + 1 Using Progression 1.028737345;

// Entrada: seis elementos y concentracion hacia x=5.
Transfinite Curve {-1,-3,-6} = 6*r + 1 Using Progression 1.057371263;

// Toda la estela en una sola progresion continua: x=6 hasta x=40.
// La raiz cuarta conserva la misma graduacion global que la malla validada de level 0.
Transfinite Curve {2,5,8} = 40*r + 1 Using Progression 1.006192246;
