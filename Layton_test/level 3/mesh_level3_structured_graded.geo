// Layton et al. - Level 3 (refinamiento r=4)
...
Transfinite Curve {-15, -13, -2, 10, 31, 25, 22, 20, -43, -38, 36} =
  10*r + 1 Using Progression 1.028737345;
Transfinite Curve {14, 16, -18, -40, 42, 44} =
  6*r + 1 Using Progression 1.057371263;
Transfinite Curve {-32, -30, 45, -47, -48} =
  6*r + 1 Using Progression 1.028737345;
Transfinite Curve {-26, -24, 33} =
  14*r + 1 Using Progression 1.019426547;
Transfinite Curve {-23, -21, 28} =
  20*r + 1 Using Progression 0.992637536;
