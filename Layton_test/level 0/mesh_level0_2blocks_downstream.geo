// Layton et al. - Level 0 simplificado.
...
Transfinite Curve {10,12,14,16} = 10*r + 1 Using Progression 1.15;

// Entrada: seis elementos y concentracion hacia x=5.
Transfinite Curve {-1,-3,-6} = 6*r + 1 Using Progression 1.25;

// Toda la estela en una sola progresion continua: x=6 hasta x=40.
// En level 0: primer elemento ~0.50 y ultimo ~1.32.
Transfinite Curve {2,5,8} = 40*r + 1 Using Progression 1.045;
